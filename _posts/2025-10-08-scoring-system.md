...
&= \cancel{-2S_r(1 - 1)} + 2S_r\Tsecondp{N_0 - 2} + \cancel{2S_r(1 - 1)^{2}} - 2S_r\Tsecondsp{N_0 - 2} + {}\\
&\ \ \ \ \ \  \cancel{2S_0(1 - 1)} - 2S_0\Tsecondp{N_0 - 2} - \cancel{S_0(1 - 1)^{2}} + S_0\Tsecondsp{N_0 - 2} - {}\\
&\ \ \ \ \ \  \cancel{S_n(1 - 1)^{2}} + S_n\Tsecondsp{N_0 - 2}\\
